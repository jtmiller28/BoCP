...
#SBATCH --job-name=spatial-flagging              # Job name
...
#SBATCH --output=/blue/guralnick/millerjared/BoCP/logs/spatial-flagging/spatial-flagging%A-%a.out                 # Standard output and error log
#SBATCH --nodes=1                        # Run all processes on a single node
#SBATCH --ntasks=1                       # Run a single task
#SBATCH --cpus-per-task=1               # Number of CPU cores per task
#SBATCH --mem-per-cpu=300gb                   # Job memory request
...
Rscript --vanilla /blue/guralnick/millerjared/BoCP/finished-code/r/005-spatial-flagging.R
