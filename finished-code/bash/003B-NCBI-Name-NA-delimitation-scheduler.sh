...
#SBATCH --job-name=ncbi-na-delimitation-array               # Job name
...
#SBATCH --output=/blue/guralnick/millerjared/BoCP/logs/ncbi-name-na-delim/ncbi_name_delim_%A-%a.out                 # Standard output and error log
...
Rscript --vanilla /blue/guralnick/millerjared/BoCP/finished-code/r/003B-NCBI-Name-NA-delimitation.R
