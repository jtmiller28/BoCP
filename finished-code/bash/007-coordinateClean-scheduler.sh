...
#SBATCH --job-name=coordinateClean             # Job name
...
#SBATCH --output=/blue/guralnick/millerjared/BoCP/logs/coordinateClean/coordinateCleaning%A-%a.out                 # Standard output and error log
...
Rscript --vanilla /blue/guralnick/millerjared/BoCP/finished-code/r/007-coordinateClean.R
