...
#SBATCH --job-name=gbif-occurrence-downloads-sb15      # Job name
...
Rscript --vanilla /blue/guralnick/millerjared/BoCP/finished-code/r/002B-dw-subsets/002B-download-occur-data-sb15.R

## example for running: sbatch /blue/guralnick/millerjared/BoCP/finished-code/bash/002B-dw-subsets/002B-download-scheduler-sb15.sh
