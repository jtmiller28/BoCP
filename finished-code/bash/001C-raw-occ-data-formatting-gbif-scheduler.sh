...
#SBATCH --job-name=gbif-raw-data-formatting     # Job name
#SBATCH --mail-type=ALL                  # Mail events (NONE, BEGIN, END, FAIL, ALL)
#SBATCH --mail-user=jtmiller@ucsb.edu    # Where to send mail
#SBATCH --output=/blue/guralnick/millerjared/BoCP/logs/data-formatting/gbif-raw-data-formatting%j.log                  # Standard output and error log
...
Rscript --vanilla /blue/guralnick/millerjared/BoCP/finished-code/r/001C-raw-occ-data-formatting-gbif.R
done
## example for running: sbatch /blue/guralnick/millerjared/BoCP/finished-code/bash/001C-raw-occ-data-formatting-gbif-scheduler.sh