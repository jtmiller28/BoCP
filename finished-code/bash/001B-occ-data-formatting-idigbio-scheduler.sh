...
#SBATCH --job-name=idigbio-all-data-parquet-formatting     # Job name
...
Rscript --vanilla /blue/guralnick/millerjared/BoCP/finished-code/r/001B-occ-data-formatting-idigbio.R
