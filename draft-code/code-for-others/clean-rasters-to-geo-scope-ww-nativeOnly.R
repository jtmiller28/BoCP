...
# saveRDS(unfinished_files, "/blue/guralnick/millerjared/BoCP/data/processed/grid-project/worldwide/unfinished-native-mask-names.rds")
unfinished_files <- readRDS("/blue/guralnick/millerjared/BoCP/data/processed/grid-project/worldwide/unfinished-native-mask-names.rds")
...
fwrite(sp_50_df, file = "/home/millerjared/blue_guralnick/millerjared/BoCP/data/processed/grid-project/worldwide/raster-species-PA-visuals/community-richness-50x50/community-sp-PA-makeup.csv", 
...
fwrite(sp_25_df, file = "/home/millerjared/blue_guralnick/millerjared/BoCP/data/processed/grid-project/worldwide/raster-species-PA-visuals/community-richness-25x25/community-sp-PA-makeup.csv", 
