...
#SBATCH --job-name=grid-spatial-data-array              # Job name
...
#SBATCH --output=/blue/guralnick/millerjared/BoCP/logs/grid-project/grid-data_%A-%a.out                 # Standard output and error log
...
Rscript --vanilla /blue/guralnick/millerjared/BoCP/draft-code/code-for-others/merge-occs-and-grid.R
