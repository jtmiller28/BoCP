...
#SBATCH --job-name=count-outliers-for-grids             # Job name
...
#SBATCH --output=/blue/guralnick/millerjared/BoCP/logs/grid-project/outliers_%A-%a.out                 # Standard output and error log
...
Rscript --vanilla /blue/guralnick/millerjared/BoCP/draft-code/code-for-others/grid-outlier-numbers.R
