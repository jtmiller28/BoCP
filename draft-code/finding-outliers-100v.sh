...
#SBATCH --job-name=finding-outliers-fxnal-run             # Job name
...
#SBATCH --output=/blue/guralnick/millerjared/BoCP/logs/findin-outliers-fxnal-run_%A-%a.out                 # Standard output and error log
...
Rscript --vanilla /blue/guralnick/millerjared/BoCP/prototype-code/finding-outliers-fxn.R

done

date
## example for running: sbatch /blue/guralnick/millerjared/BoCP/prototype-code/finding-outliers-fxn.sh