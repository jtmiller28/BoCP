...
#SBATCH --job-name=finding-outliers-fxnal             # Job name
...
#SBATCH --output=/blue/guralnick/millerjared/BoCP/logs/findin-outliers-fxn_%A-%a.out                 # Standard output and error log
