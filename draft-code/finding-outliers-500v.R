...
our_tdi <- 500 # whatever we're declaring as the TDI for this run on outlier analysis 
...
spThin::thin(occur_data, 
             ...
             out.dir = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-data/500km/", "thinning-", thinning_dist[i], "km"),
             thin.par = 1 # 1 km
)
occur_data <- fread(paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-data/500km/", "thinning-", thinning_dist[i], "km/",  "thinned_data_thin1.csv"))
...
ggsave(plot = distance_plot, filename = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-data/500km/", accepted_name_filestyle, "-native-data-distribution-distance-method-plot.jpg"), height = 10, width = 10)
...
ggsave(plot = mad_plot, filename = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-data/500km/", accepted_name_filestyle, "-native-data-distribution-mad-method-plot.jpg"), height = 10, width = 10)
...
# create a pdf output
pdf(file = paste0("./outputs/outlier-pdfs/native-data/500km/", accepted_name_filestyle),  width = 30, height = 30)
...
fwrite(native_outlier_removal_summary, paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-data/500km/", accepted_name_filestyle, "-native-data-outlier-removal-summary.csv"))
...
spThin::thin(occur_data, 
             ...
             write.files = TRUE,
             out.base = "thinned_data",
             out.dir = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/all-data/500km/", "thinning-", thinning_dist[i], "km"),
             thin.par = 1 # 1 km
)
occur_data <- fread(paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/all-data/500km/", "thinning-", thinning_dist[i], "km/",  "thinned_data_thin1.csv"))
occur_data <- mutate(occur_data, id = 1:n())
...
ggsave(plot = distance_plot, filename = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/all-data/500km/", accepted_name_filestyle, "-all-data-distribution-distance-method-plot.jpg"), height = 10, width = 10)
...
mad_plot <- ggplot() +
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 0.5, hjust=1)) +
  ggtitle(paste0("All Distribution for ", accepted_name, " of ", quantile_id, " quantile", "\n using Mean Absolute Distance Method with", our_tdi, "km outlier threshold"))
ggsave(plot = mad_plot, filename = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/all-data/500km/", accepted_name_filestyle, "-all-data-distribution-mad-method-plot.jpg"), height = 10, width = 10)
...
# create a pdf output
pdf(file = paste0("./outputs/outlier-pdfs/all-data/500km/", accepted_name_filestyle),  width = 30, height = 30)
grid.arrange(distance_plot, distance_w_buffer_plot,  mad_plot, mad_hist_plot, ncol = 1)
dev.off()

fwrite(all_outlier_removal_summary, paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/all-data/500km/", accepted_name_filestyle, "-all-data-outlier-removal-summary.csv"))
...
spThin::thin(occur_data, 
             ...
             write.files = TRUE,
             out.base = "thinned_data",
             out.dir = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-plus-introduced-data/500km/", , "thinning-", thinning_dist[i], "km"),
             thin.par = 1 # 1 km
)
occur_data <- fread(paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-plus-introduced-data/500km/", "thinning-", thinning_dist[i], "km/",  "thinned_data_thin1.csv"))
...
ggsave(plot = distance_plot, filename = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-plus-introduced-data/500km/", accepted_name_filestyle, "-native-plus-introduced-data-distribution-distance-method-plot.jpg"), height = 10, width = 10)
...
mad_plot <- ggplot() +
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 0.5, hjust=1)) +
  ggtitle(paste0("Native and Introduced Distribution for ", accepted_name, " of ", quantile_id, " quantile", "\n using Mean Absolute Distance Method with", our_tdi, "km outlier threshold"))
ggsave(plot = mad_plot, filename = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-plus-introduced-data/500km/", accepted_name_filestyle, "-native-plus-introduced-data-distribution-mad-method-plot.jpg"), height = 10, width = 10)
...
# create a pdf output
pdf(file = paste0("./outputs/outlier-pdfs/native-and-introduced-data/500km/", accepted_name_filestyle),  width = 30, height = 30)
grid.arrange(distance_plot, distance_w_buffer_plot,  mad_plot, mad_hist_plot, ncol = 1)
dev.off()
fwrite(native_and_introduced_outlier_removal_summary, paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-plus-introduced-data/500km/", accepted_name_filestyle, "-native-plus-introduced-outlier-removal-summary.csv"))
}