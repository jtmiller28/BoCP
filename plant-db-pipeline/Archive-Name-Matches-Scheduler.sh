...
#SBATCH --output=/blue/guralnick/millerjared/BoCP/logs/plantdb-archive-name-matches/table%A-%a.out                 # Standard output and error log
...
Rscript --vanilla /blue/guralnick/millerjared/BoCP/plant-db-pipeline/Archive-Name-Matches.R
