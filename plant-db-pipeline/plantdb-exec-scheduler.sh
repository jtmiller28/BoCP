...
#SBATCH --output=/blue/guralnick/millerjared/BoCP/logs/build-sp-tables-plantdb/sp-table-build%A-%a.out                 # Standard output and error log
...
Rscript --vanilla /blue/guralnick/millerjared/BoCP/plant-db-pipeline/plantdb-exec.R
