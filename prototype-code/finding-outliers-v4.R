...
spThin::thin(occur_data, 
             ...
             out.dir = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-data/"),
             thin.par = 1 # 1 km
             )
occur_data <- fread(paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-data/thinned_data_thin1.csv"))
...
ggsave(plot = distance_plot, filename = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-data/", accepted_name_filestyle, "-native-data-distribution-distance-method-plot.jpg"), height = 10, width = 10)
mad_plot <- ggplot() +
  geom_sf(region_fills, mapping = aes(fill = regionStatus), color = "black") +
  scale_fill_manual(values = color_mapping) +
...
ggsave(plot = mad_plot, filename = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-data/", accepted_name_filestyle, "-native-data-distribution-mad-method-plot.jpg"), height = 10, width = 10)
...
# create a pdf output
pdf(file = paste0("./outputs/outlier-pdfs/native-data/", accepted_name_filestyle),  width = 8, height = 11)
grid.arrange(distance_plot, mad_plot, quantile_plot, ncol = 1)
dev.off()
...
spThin::thin(occur_data, 
             ...
             write.files = TRUE,
             out.base = "thinned_data",
             out.dir = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/all-data/"),
             thin.par = 1 # 1 km
)
occur_data <- fread(paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/all-data/thinned_data_thin1.csv"))
...
ggsave(plot = distance_plot, filename = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/all-data/", accepted_name_filestyle, "-all-data-distribution-distance-method-plot.jpg"), height = 10, width = 10)
mad_plot <- ggplot() +
  geom_sf(region_fills, mapping = aes(fill = regionStatus), color = "black") +
  scale_fill_manual(values = color_mapping) +
  geom_sf(data = occur_data_sf, mapping = aes(color = madOutlierFlagged)) +  # Map fill based on whether the point is to be removed
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 0.5, hjust=1)) +
  ggtitle(paste0("All Distribution for ", accepted_name, " of ", quantile_id, " quantile", "\n using Mean Absolute Distance Method with 100km outlier threshold"))
ggsave(plot = mad_plot, filename = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/all-data/", accepted_name_filestyle, "-all-data-distribution-mad-method-plot.jpg"), height = 10, width = 10)
quantile_plot <- ggplot() +
  geom_sf(region_fills, mapping = aes(fill = regionStatus), color = "black") +
  scale_fill_manual(values = color_mapping) +
  geom_sf(data = occur_data_sf, mapping = aes(color = quantileOutlierFlagged)) +  # Map fill based on whether the point is to be removed
...
# create a pdf output
pdf(file = paste0("./outputs/outlier-pdfs/all-data/", accepted_name_filestyle),  width = 8, height = 11)
grid.arrange(distance_plot, mad_plot, quantile_plot, ncol = 1)
dev.off()
...
spThin::thin(occur_data, 
             ...
             write.files = TRUE,
             out.base = "thinned_data",
             out.dir = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-plus-introduced-data/"),
             thin.par = 1 # 1 km
)
occur_data <- fread(paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-plus-introduced-data/thinned_data_thin1.csv"))
...
ggsave(plot = distance_plot, filename = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-plus-introduced-data/", accepted_name_filestyle, "-native-plus-introduced-data-distribution-distance-method-plot.jpg"), height = 10, width = 10)
mad_plot <- ggplot() +
  geom_sf(region_fills, mapping = aes(fill = regionStatus), color = "black") +
  scale_fill_manual(values = color_mapping) +
  geom_sf(data = occur_data_sf, mapping = aes(color = madOutlierFlagged)) +  # Map fill based on whether the point is to be removed
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 0.5, hjust=1)) +
  ggtitle(paste0("Native and Introduced Distribution for ", accepted_name, " of ", quantile_id, " quantile", "\n using Mean Absolute Distance Method with 100km outlier threshold"))
ggsave(plot = mad_plot, filename = paste0("./outputs/testing-outlier-removal/", accepted_name_filestyle, "/native-plus-introduced-data/", accepted_name_filestyle, "-native-plus-introduced-data-distribution-mad-method-plot.jpg"), height = 10, width = 10)
quantile_plot <- ggplot() +
  geom_sf(region_fills, mapping = aes(fill = regionStatus), color = "black") +
  scale_fill_manual(values = color_mapping) +
  geom_sf(data = occur_data_sf, mapping = aes(color = quantileOutlierFlagged)) +  # Map fill based on whether the point is to be removed
...
# create a pdf output
pdf(file = paste0("./outputs/outlier-pdfs/native-and-introduced-data/", accepted_name_filestyle),  width = 8, height = 11)
grid.arrange(distance_plot, mad_plot, quantile_plot, ncol = 1)
dev.off()
