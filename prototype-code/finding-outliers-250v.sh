...
#SBATCH --job-name=finding-outliers-250               # Job name
...
#SBATCH --output=/blue/guralnick/millerjared/BoCP/logs/findin-outliers-250km-array_%A-%a.out                 # Standard output and error log
...
Rscript --vanilla /blue/guralnick/millerjared/BoCP/prototype-code/finding-outliers-250v.R
